...
export class LeavesComponent {
  ...
  leaveSave() {
    ...
    this.leave.createLeave(this.leaveModel).subscribe(
      (res) => {
        console.log(res);
        alert('Leave Save');
  ...
  deleteLeave(row: any) {
    this.leave.deleteLeave(row.id).subscribe(
      (res) => {
        console.log(res);
        alert('leave Deleted');
        this.formValue.reset();
  ...
  leaveEdit() {
    ...
    this.leave.editLeave(this.leaveModel.id, this.leaveModel).subscribe(
      (res) => {
        console.log(res);
        alert('Leave Updated');
        this.formValue.reset();
