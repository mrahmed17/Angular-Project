...
export class DepartmentComponent implements OnInit {
  ...
  saveDepartment() {
    ...
    this.department.departmentPost(this.departmentModel).subscribe(
      (res) => {
        console.log(res);
  ...
  getAll() {
    this.department.getAllDepartments().subscribe((res) => {
  ...
  departmentEdit() {
    ...
    this.department
      .editDepartment(this.departmentModel.id, this.departmentModel)
      .subscribe(
        (res) => {
          console.log(res);
