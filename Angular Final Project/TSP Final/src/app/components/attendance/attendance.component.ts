...
export class AttendanceComponent implements OnInit {
  ...
  saveAttendance() {
    ...
    this.attendance.attendancePost(this.attendanceModel).subscribe(
      (res) => {
        console.log(res);
  ...
  getAll() {
    this.attendance.getAllAttendance().subscribe((res) => {
  ...
  onEdit(row: any) {
    ...
    this.attendance
      .editAttendance(checkOutAttendance.id, checkOutAttendance)
      .subscribe(
        (res) => {
          console.log(res);
